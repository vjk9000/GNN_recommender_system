...
from utils.make_embedding import BLaIR_roberta_base_text_embedding_model, save_embedding
...
## Save dir
product_df_save_name = "meta_features_base"
two_split_review_train_agg_save_name = "train_user_reviews_features_base"
two_split_review_test_agg_save_name = "test_user_reviews_features_base"
three_split_review_train_agg_save_name = "train_user_reviews_features_base"
three_split_review_test_agg_save_name = "test_user_reviews_features_base"
three_split_review_valid_agg_save_name = "valid_user_reviews_features_base"
...
# embed 
product_df_embed = BLaIR_roberta_base_text_embedding_model(product_df[product_col].to_list(), batch_size, max_length, device)
...
two_split_review_train_agg_embed = BLaIR_roberta_base_text_embedding_model(two_split_review_train_agg[user_col].to_list(), batch_size, max_length, device)
save_embedding(two_split_review_train_agg_embed, f"{save_dir}/{two_split}/{two_split_review_train_agg_save_name}.pt")
del two_split_review_train_agg_embed
print(f"done with two_split_review_train_agg_save_name")

two_split_review_test_agg_embed = BLaIR_roberta_base_text_embedding_model(two_split_review_test_agg[user_col].to_list(), batch_size, max_length, device)
save_embedding(two_split_review_test_agg_embed, f"{save_dir}/{two_split}/{two_split_review_test_agg_save_name}.pt")
del two_split_review_test_agg_embed
print(f"done with two_split_review_test_agg_save_name")

three_split_review_train_agg_embed = BLaIR_roberta_base_text_embedding_model(three_split_review_train_agg[user_col].to_list(), batch_size, max_length, device)
save_embedding(three_split_review_train_agg_embed, f"{save_dir}/{three_split}/{three_split_review_train_agg_save_name}.pt")
del three_split_review_train_agg_embed
print(f"done with three_split_review_train_agg_save_name")

three_split_review_test_agg_embed = BLaIR_roberta_base_text_embedding_model(three_split_review_test_agg[user_col].to_list(), batch_size, max_length, device)
save_embedding(three_split_review_test_agg_embed, f"{save_dir}/{three_split}/{three_split_review_test_agg_save_name}.pt")
del three_split_review_test_agg_embed
print(f"done with three_split_review_test_agg_save_name")

three_split_review_valid_agg_embed = BLaIR_roberta_base_text_embedding_model(three_split_review_valid_agg[user_col].to_list(), batch_size, max_length, device)
save_embedding(three_split_review_valid_agg_embed, f"{save_dir}/{three_split}/{three_split_review_valid_agg_save_name}.pt")
del three_split_review_valid_agg_embed
